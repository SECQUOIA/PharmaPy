...
echo ------------------------------
pip install -r requirements-assimulo.txt || echo "[WARN] Assimulo installation failed - PharmaPy will work with limited functionality"
echo ----------------------
...
echo ------------------------------
python -c "import PharmaPy; print('[OK] PharmaPy installed successfully')"
python -c "from PharmaPy import Utilities; print('[OK] Core modules working')"
python -c "from PharmaPy import Reactors; print('[OK] Simulation modules working')" || echo "[WARN] Simulation modules require assimulo"
echo ------------------------------
