...
class SolidStream(SolidPhase):
    ...
    @property
    def vol_flow(self):
        return self.mass_flow/self.getDensity(mass_frac=self.mass_frac)
    @property
    def mass_j_flow(self):
        return self.mass_flow*self.mass_frac
    ...
    def mass_j_flow(self, value):
        ...
        self.updatePhase(mass_flow=self.mass_flow,mass_frac = mass_frac)
    def updatePhase(self, x_distrib=None, distrib=None, mass_flow=None, moments=None, temp=None, mass_j=None, vol_flow=None):

        super().updatePhase(x_distrib, distrib, mass_flow, moments, temp, mass_j, vol_flow)
        self.mass_flow = self.mass
