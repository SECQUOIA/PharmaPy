...
def run_reactor_tests():
    ...
    success, stdout, stderr = run_command(
        [sys.executable, "reactor_tests.py"], cwd=test_dir
    )
...
def run_flowsheet_tests():
    ...
    success, stdout, stderr = run_command(
        [sys.executable, "flowsheet_tests.py"], cwd=test_dir
    )
...
def main():
    ...
    parser.add_argument(
        "--skip-reactor", action="store_true", help="Skip reactor tests"
    )
    parser.add_argument(
        "--skip-flowsheet", action="store_true", help="Skip flowsheet tests"
    )
    parser.add_argument("--skip-pytest", action="store_true", help="Skip pytest tests")
    parser.add_argument(
        "--skip-installation", action="store_true", help="Skip installation tests"
    )
